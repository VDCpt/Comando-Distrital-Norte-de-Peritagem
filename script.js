/**
 * VDC SISTEMA DE PERITAGEM FORENSE · v12.7.1 SMOKING GUN
...
console.log('VDC SCRIPT v12.7.1 · SMOKING GUN · MODO PROFISSIONAL ATIVADO');
...
const translations = {
    pt: {
        ...
        pdfFooterLine3: "VDC Systems International © 2024/2026 | Módulo de Peritagem Forense v12.7.1 | SMOKING GUN | COLARINHO BRANCO",
        pdfLabelName: "Nome",
        pdfLabelNIF: "NIF",
    ...
    en: {
        ...
        pdfFooterLine3: "VDC Systems International © 2024/2026 | Forensic Expertise Module v12.7.1 | SMOKING GUN | WHITE COLLAR",
        pdfLabelName: "Name",
        pdfLabelNIF: "Tax ID",
...
function updateLoadingProgress(percent) {
    ...
    if (text) text.textContent = `MÓDULO FORENSE BIG DATA v12.7.1... ${percent}%`;
}
...
function showMainInterface() {
    ...
    logAudit('SISTEMA VDC v12.7.1 MODO PROFISSIONAL ATIVADO · SMOKING GUN ONLINE', 'success');
...
function activateDemoMode() {
    ...
    logAudit('🚀 ATIVANDO CASO SIMULADO v12.7.1 SMOKING GUN...', 'info');
...
function updateDashboard() {
    ...
    if (quantumNoteEl) {
        quantumNoteEl.textContent = `IVA em falta (23%): ${formatCurrency(cross.ivaFalta)}`;
    }
...
function showAlerts() {
    ...
    // Verdict Display - Agora Parecer Técnico
    ...
    // Big Data Alert - Agora Smoking Gun
...
function renderChart() {
    ...
    const labels = ['SAF-T Bruto', 'Ganhos App', 'Comissões', 'Faturado', 'DAC7 Q4', 'Líquido', 'IVA Falta'];
    const data = [
        ev.saftBruto || 0,
        ev.ganhosApp || 0,
        ev.comissaoTotal || 0,
...
function exportPDF() {
    ...
    try {
        ...
        doc.text(`IVA em falta (23%): ${formatCurrency(cross.ivaFalta || 0)}`, left, y); y += 10;
        ...
        doc.text(`HASH: ${VDCSystem.masterHash || 'NÃO GERADA'} · RFC 3161`, 105, 295, { align: 'center' });
...
/* =====================================================================
   FIM DO FICHEIRO SCRIPT.JS · v12.7.1 SMOKING GUN
   ===================================================================== */
